...
public class BombermanGame extends Application {
    ...
    public static final String Map = "res/TileMap/Map";
    public static final String mapMonster = "res/TileMap/Tile_monster";
    public static final String mapItem = "res/TileMap/Tile_item";
    public static final String scoreFile = "res/Point/score.txt";
